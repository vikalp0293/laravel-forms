    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Student Test Report</h3>
            ...
            <table class="broadcast-init nowrap nk-tb-list is-separate" data-auto-responsive="true">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col"><span class="sub-text">Test Name</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Test Number</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Test Results</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Time(s) Attempted</span></th>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var datatableUrl = root_url + '/stats/student-test-report/'+stat_id;
