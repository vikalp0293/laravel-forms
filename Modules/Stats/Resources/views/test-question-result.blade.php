    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Test Question Results</h3>
            ...
            <table class="broadcast-init nowrap nk-tb-list is-separate" data-auto-responsive="true">
                <thead>
                    <tr class="nk-tb-item nk-tb-head">
                        ...
                        <th class="nk-tb-col"><span class="sub-text">Question Text</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Correct Answer</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Total Correct</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Total Attempted</span></th>
                        <th class="nk-tb-col"><span class="sub-text">Stats</span></th>
                    </tr>
                </thead>
                <tbody>
                </tbody>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        var exam_uuid = "<?php echo $exam_uuid; ?>";
        var datatableUrl = root_url + '/stats/test-question-result/'+exam_uuid;
