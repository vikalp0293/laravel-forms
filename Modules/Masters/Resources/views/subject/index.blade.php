...
@endphp
            ...
            <div class="nk-block-head-content">
                ...
                @php 
                    if(count($subjects) > 1) 
                        ...
                        $count = 'subject';                       
                @endphp
                <p>You have total <span class="record_count">{{ count($subjects) }}</span> {{ $count }}.</p>
    ...
    <div class="nk-block table-compact">
        ...
        <form role="form" id="addForm" method="post" action="{{ url('masters/subject/add') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="form-label" for="subject">Status</label>
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if(arr.length==0){
            ...
            $.ajax({
                url: root_url + '/masters/subject/mass-update',
    ...
    $(function() {
        ...
        $('.table-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/masters/subject/get-subject',
                data: {'id':id},
                //dataType: "html",
                method: "GET",
                cache: false,
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $('#manufStatus').attr('checked', data.subject.status == "active"? true : false);
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: root_url + '/masters/subject/delete',
                data: {
                    'id': id
                },
                //dataType: "html",
