...
@endphp
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Grades</h3>
                @php 
                    if(count($grades) > 1) 
                        $count = 'grades';
                    else
                        $count = 'grade';                       
                @endphp
                <p>You have total <span class="record_count">{{ count($grades) }}</span> {{ $count }}.</p>
    ...
    <div class="nk-block table-compact">
        ...
        <form role="form" id="addForm" method="post" action="{{ url('masters/grade/add') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="form-label" for="grade">Status</label>
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if(arr.length==0){
            ...
            $.ajax({
                url: root_url + '/masters/grade/mass-update',
    ...
    $(function() {
        ...
        $('.table-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/masters/grade/get-grade',
                data: {'id':id},
                //dataType: "html",
                method: "GET",
                cache: false,
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $('#name').val(data.grade.name);
                        $('#description').val(data.grade.description);
                        $('.submitBtn').text('Update');
                        
                        $('#manufStatus').attr('checked', data.grade.status == "active"? true : false);
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: root_url + '/masters/grade/delete',
                data: {
                    'id': id
                },
                //dataType: "html",
