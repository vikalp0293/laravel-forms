...
@endphp
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Subtopics</h3>
                @php 
                    if(count($subtopics) > 1) 
                        ...
                        $count = 'subtopic';                       
                @endphp
                <p>You have total <span class="record_count">{{ count($subtopics) }}</span> {{ $count }}.</p>
    ...
    <div class="nk-block table-compact">
        ...
        <form role="form" id="addForm" method="post" action="{{ url('masters/subtopic/add') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="nk-block">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-mb-12">
                        ...
                        <select size="sm" class="form-select form-control form-control-lg" data-placeholder="Topic" data-parsley-errors-container=".categoryParsley" name="topic_id" id="parentCat" data-search='on' required> 
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="form-label" for="subtopic">Status</label>
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if(arr.length==0){
            ...
            $.ajax({
                url: root_url + '/masters/subtopic/mass-update',
    ...
    $(function() {
        ...
        $('.table-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/masters/subtopic/get-subtopic',
                data: {'id':id},
                //dataType: "html",
                method: "GET",
                cache: false,
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $('#name').val(data.subtopic.name);
                        $('#parentCat').val(data.subtopic.topic_id).trigger('change');
                        $('.submitBtn').text('Update');
                        
                        $('#manufStatus').attr('checked', data.subtopic.status == "active"? true : false);
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: root_url + '/masters/subtopic/delete',
                data: {
                    'id': id
                },
                //dataType: "html",
