...
@endphp
    ...
    <div class="nk-block table-compact">
        ...
        <form role="form" id="addForm" method="post" action="{{ url('masters/state/add') }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="nk-block">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-mb-12">
                        <label class="form-label" for="site-name">Country</span></label>
                        <select size="sm" class="form-select form-control form-control-lg" data-placeholder="Country" data-parsley-errors-container=".categoryParsley" name="country_id" id="parentCat" data-search='on'> 
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if(arr.length==0){
            ...
            $.ajax({
                url: root_url + '/masters/state/mass-update',
    ...
    $(function() {
        ...
        $('.table-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/masters/state/get-state',
                data: {'id':id},
                //dataType: "html",
                method: "GET",
                cache: false,
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $('#parentCat').val(data.state.country_id).trigger('change');
                        $('.submitBtn').text('Update');
                        
                        $('#manufStatus').attr('checked', data.state.status == "active"? true : false);
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: root_url + '/masters/state/delete',
                data: {
                    'id': id
                },
                //dataType: "html",
