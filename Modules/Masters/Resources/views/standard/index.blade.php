...
@endphp
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Standards</h3>
                @php 
                    if(count($standards) > 1) 
                        ...
                        $count = 'standard';                       
                @endphp
                <p>You have total <span class="record_count">{{ count($standards) }}</span> {{ $count }}.</p>
    ...
    <div class="nk-block table-compact">
        ...
        <form role="form" id="addForm" method="post" action="{{ url('masters/standard/add') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            <label class="form-label" for="standard">Status</label>
...
<script type="text/javascript">
    ...
    function updateMassItems() {
        ...
        if(arr.length==0){
            ...
            $.ajax({
                url: root_url + '/masters/standard/mass-update',
    ...
    $(function() {
        ...
        $('.table-init').on('click', '.editItem', function() {
            ...
            $.ajax({
                url: root_url + '/masters/standard/get-standard',
                data: {'id':id},
                //dataType: "html",
                method: "GET",
                cache: false,
                success: function (data) {
                    ...
                    if(data.success){
                        ...
                        $('#name').val(data.standard.name);
                        $('#parentCat').val(data.standard.sub_topic_id).trigger('change');
                        $('.submitBtn').text('Update');
                        
                        $('#manufStatus').attr('checked', data.standard.status == "active"? true : false);
        ...
        Swal.fire({
          ...
          if (result.value) {
            ...
            $.ajax({
                url: root_url + '/masters/standard/delete',
                data: {
                    'id': id
                },
                //dataType: "html",
