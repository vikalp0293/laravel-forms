...
!function (NioApp, $) {
  ...
  var barChartStacked = {
        labels : ["Cable", "Clutch", "Headlight", "Wire", "Brake", "Engine Oil", "Back Light", "Cover", "Coolant", "Bumper", "Engine", "Steering"],
        stacked: true,
        dataUnit : 'INR',
        datasets : [{
            label : "Orders",
            color : "#FF6492",
            data: [1100, 780, 125, 155, 195, 175, 190, 1110, 1080, 1025, 550, 955]
        },{
            label : "Pending Orders",
            color : "#141446",
            data: [750, 950, 110, 480, 125, 355, 595, 675, 790, 1020, 980, 1025]
        },{
            label : "Completed Orders",
            color : "#7A77FF",
            data: [905, 1012, 1085, 850, 225, 754, 824, 674, 474, 584, 907, 290]
        }]
    };
