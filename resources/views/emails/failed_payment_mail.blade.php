    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td style="background: rgb(218,255,0); padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
                        <table>
                            <tr>
                                <td style="font-family: arial; font-size: 24px; font-weight: 700; color: #000;">Booking - Auto Payment Failed</td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                ...
                <tr>
                    <td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">We regret to inform you that the automatic <strong>USD {{ $bookingDetail->total-$bookingDetail->deposit_amount }}</strong> payment for your reservation at <strong>{{ $bookingDetail->hotel_name }}</strong> was unsuccessful. But don't worry, your reservation is still secure. The remaining balance can be paid on SevennUp in the section for upcoming stays.</td>
                </tr>                       
            </tbody>
        </table>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                ...
                <tr>
                    <td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">Please be aware that if the balance is not paid by {{ date('Y-m-d',strtotime($bookingDetail->auto_charge_failed."+2 days")) }}, your reservation will be cancelled.</td>
                </tr>                       
            </tbody>
        </table>
