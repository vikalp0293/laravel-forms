    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td style="background: rgb(218,255,0); padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
                        <table>
                            <tr>
                                <td style="font-family: arial; font-size: 24px; font-weight: 700; color: #000;">Booking - Cancelled</td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                ...
                <tr>
                    <td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">We regret to inform you that despite our best efforts, your reservation at <strong>{{ $bookingDetail->hotel_name }}</strong> could not be confirmed despite repeated tries and an email requesting payment of <strong>USD {{ $bookingDetail->total-$bookingDetail->deposit_amount }}</strong>. Your reservation has been <strong>cancelled</strong> as a result.</td>
                </tr>                       
            </tbody>
        </table>
