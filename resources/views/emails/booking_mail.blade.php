    ...
    <body>
            ...
            <tbody>
                <tr>
                    <td style="background: rgb(218,255,0); padding-left: 15px;padding-top: 10px; padding-bottom: 10px">
                        <table>
                            <tr>
                                <td style="font-family: arial; font-size: 24px; font-weight: 700; color: #000;">SevennUp Hotel Booking</td>
                            </tr>
                        </table>
                    </td>
                </tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                ...
                <tr>
                    <td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">Thank you for booking. We'd like to let you know that your booking <strong>{{ $bookingDetail->hotel_name }}</strong> is confirmed.</td>
                </tr>                       
            </tbody>
        </table>
        ...
        @if($bookingDetail->deposit_amount < $bookingDetail->total)

        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center">
            <tbody>
                <tr>
                    <td style="color:#FF8000; font-size: 16px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: 600">Booking Notes</td>
                </tr>
                <tr>
                    <td style="color:#000; font-size: 14px; font-family: arial; padding-top: 10px; padding-bottom: 10px; font-weight: normal; line-height:20px;">We have currently charged you <strong>USD {{ $bookingDetail->deposit_amount }}</strong> <br>
                        Remaining amount will be auto deducted once we cross the cancellation policy grace period of {{ $bookingDetail->cancellation_days }} days is over.</td>
                </tr>                       
            </tbody>
        </table>
        @endif
